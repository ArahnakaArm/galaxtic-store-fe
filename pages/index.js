...
export default function Home() {
  ...
  const [topProductItem, setTopProductItem] = useState([]);
  const responsive = {
    superLargeDesktop: {
  ...
  const getTopProduct = async () => {
    const topProducts = await apiService("GET", "product");
    setTopProductItem(topProducts.resultData);
  };
  ...
  return (
    <div>
      ...
      <div className="flex justify-center">
        {!isLoaded && (
          <div className="h-[80vh] flex items-center -mb-2">
            ...
            <div className="grid grid-cols-3 mt-2 lg:mt-4 md:mt-4 sm:mt-4">
              <Carousel
                ...
                renderIndicator={(onClickHandler, isSelected, index, label) => {
                  ...
                  const style = isSelected ? { ...defStyle, background: "red" } : { ...defStyle };
                  return <li style={style} onClick={onClickHandler} onKeyDown={onClickHandler} value={index} key={index} role="button" tabIndex={0}></li>;
                }}
              >
                {carouselBanner.map((item) => {
                  return (
                    <div className="cursor-pointer" key={item.monthly_promotion_id} onClick={() => onClickCarouselBanner(item)}>
            ...
            <div className="grid grid-cols-6 mt-6 min-h-[100px]">
              <div className="lg:col-span-1 md:col-span-1 sm:col-span-2 col-span-3 flex justify-center mt-1 lg:mt-0 md:mt-0 sm:mt-1">
                <div className="cursor-pointer hover:-mt-1">
                  <div className="flex justify-center">
                    {" "}
                    <div className="rounded-lg border-2 px-2 px-1 py-1 inline-block">
            ...
            <div id="category">
              ...
              <div id="categoryList" className="grid grid-cols-10 mt-3 lg:mt-3 md:mt-3 sm:mt-3">
                {categoryItem.map((cate, idx) => {
                  return (
                    <div key={cate.main_category_id} className={idx < 9 ? styles.categoryItem + " lg:col-span-1 md:col-span-1 sm:col-span-2 col-span-2" : idx == 9 ? styles.categoryItemFirstLast + " lg:col-span-1 md:col-span-1 sm:col-span-2 col-span-2" : idx == 19 ? styles.categoryItemSecondLast + " lg:col-span-1 md:col-span-1 sm:col-span-2 col-span-2" : styles.categoryItemSecondRow + " lg:col-span-1 md:col-span-1 sm:col-span-2 col-span-2"}>
                      <div>
            ...
            <div id="topProducts">
              ...
              <div className="mt-1">
                <div className="mx-auto xl:max-w-[1200px] lg:max-w-[1020px] md:max-w-[768px] sm:max-w-[600px] ssm:max-w-[400px] sssm:max-w-[400px]  max-w-[360px]">
                  ...
                  >
                    {topProductItem.map((topProduct, idx) => {
                      return (
                        <div key={topProduct.product_id}>
                          <img className="h-[150px] w-full flex" src={topProduct.product_img} />
                          <div className="text-center">{topProduct.product_name}</div>
                        </div>
                      );
                    })}
                  </CarouselMul>
